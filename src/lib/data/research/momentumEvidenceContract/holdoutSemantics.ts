import {
  ...
  type MomentumHoldoutVerdict,
} from "./momentumEvidenceContractTypes";
import { assertCandidateDefinitionImmutable } from "./shortlistPolicy";
import type { MomentumLockedHoldoutCandidate } from "./lockAndTieBreak";

export type MomentumHoldoutEvaluationInput = {
  locked: MomentumLockedHoldoutCandidate | null;
  evaluatedCandidate: MomentumCandidateDefinition | null;
...
export type MomentumHoldoutEvaluationResult = {
  verdict: MomentumHoldoutVerdict;
  rationale: string[];
  evaluatedCandidateId: string | null;
  pointEstimateFavorable: boolean | null;
};

export function buildMomentumHoldoutSemantics(): {
  evaluatesExactlyOneLockedCandidate: true;
  verdicts: readonly MomentumHoldoutVerdict[];
...
export function evaluateMomentumHoldout(
  input: MomentumHoldoutEvaluationInput,
): MomentumHoldoutEvaluationResult {
