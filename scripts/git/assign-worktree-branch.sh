...
branch_allowed() {
  ...
  case "$worktree_path" in
    *kalshi-builder1*|*kalshi-builder2*)
      [[ "$name" == feature/* ]]
      ;;
    *kalshi-review*)
...
case "$top" in
  *kalshi-builder1*|*kalshi-builder2*|*kalshi-review*)
    ...
    ;;
  *)
    echo "❌ Assign branches only from kalshi-builder1, kalshi-builder2, or kalshi-review."
    exit 1
    ;;
esac
