  ...
  try {
    ...
    io.writeStdout(
      `${stableStringify({
        ...
        recommendedSubfamily: report.recommendedSubfamily,
        recommendedNextAction: report.recommendedNextAction,
        requiresFreshOutcomeIsolation: report.requiresFreshOutcomeIsolation,
        lineageDisposition: report.lineageDisposition,
        tobImbalanceLineageDisposition: report.tobImbalanceLineageDisposition,
        historicalVerdict: report.historicalVerdict,
        prospectiveReplicationStatus: report.prospectiveReplicationStatus,
        prospectiveRequiredFreshEss: report.prospectiveRequiredFreshEss,
        completedLineage: report.completedLineage,
        completedTobImbalanceTrainLineage: report.completedTobImbalanceTrainLineage,
        microstructureContaminationReusePolicy: report.microstructureContaminationReusePolicy,
        familiesEvaluated: report.familiesEvaluated,
        confirmatoryReuseForbidden: report.confirmatoryReuseForbidden,
        candidateShoppingForbidden: report.candidateShoppingForbidden,
        promotionForbidden: report.promotionForbidden,
        freezeForbidden: report.freezeForbidden,
        prospectiveCaptureStarted: report.prospectiveCaptureStarted,
        outputPath: report.outputPath,
